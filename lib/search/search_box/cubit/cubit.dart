...
//
// class SearchAAACubit extends Cubit<SearchAAAStates> {
//   SearchAAACubit() : super(SearchInitialState());
//
//   static SearchAAACubit get(context) => BlocProvider.of(context);
//
